...
def main(argv):
    ...
    model_path = '/data/bot_img/model_0913/'
    ...
    #model def
    model_def = model_path + 'deploy_fc8-0913.prototxt'
    model_weights = model_path + 'snapshot_iter_20000.caffemodel'
    #net created
    net = caffe.Net(model_def,model_weights,caffe.TEST)
    #images mean created
    mu = np.load(model_path + 'mean.0913.npy')
    mu = mu.mean(1).mean(1)
