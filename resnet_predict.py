...
def main(argv):
    ...
    model_path = '/data/bot_img/resnet0915/'
    ...
    #model def
    model_def = model_path + 'deploy.prototxt'
    model_weights = model_path + 'resnet_50_iter_10000.caffemodel'
    #net created
    net = caffe.Net(model_def,model_weights,caffe.TEST)
    #images mean created
    mu = np.load(model_path + 'mean.0915.npy')
    mu = mu.mean(1).mean(1)
